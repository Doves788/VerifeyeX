  ...
  return (
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto space-y-24 py-12">
      ...
      <header className="text-center space-y-8 flex flex-col items-center">
        <div className="inline-flex items-center px-3 py-1 rounded-full border border-amber-500/30 bg-amber-500/10 text-amber-400 text-sm font-medium tracking-wide">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
          <SignedIn>
            <Link to="/scanner" className="px-8 py-3.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-md transition-all duration-200 active:scale-95 shadow-[0_0_20px_rgba(37,99,235,0.4)]">
              Access Live Platform
            </Link>
          </SignedIn>
          <SignedOut>
            <SignInButton mode="modal">
              <button className="px-8 py-3.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-md transition-all duration-200 active:scale-95 shadow-[0_0_20px_rgba(37,99,235,0.4)]">
      ...
      <section className="w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-xl hover:border-slate-700 transition-colors">
            <Fingerprint size={36} className="text-amber-400 mb-6" />
      ...
      {/* Trust Section */}
      <section className="w-full bg-blue-950/20 border border-amber-900/30 rounded-2xl p-10 md:p-16 text-center">
